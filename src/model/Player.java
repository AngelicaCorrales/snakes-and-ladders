...
public class Player {
	...
	*@param symbol Is the player's symbol. symbol=='*' or symbol== '!' or  symbol== 'O' or symbol== 'X' 
	...
	*@param movements Is the number of movements of the player. number greater than or equal to 0<br>
	*/
	...
	*@param next Is the next player in the linked list.<br>
	*/
	...
	*@param prev Is the previous player in the linked list.<br>
	*/
